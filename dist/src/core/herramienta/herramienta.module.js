...
HerramientaModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([herramienta_entity_1.Herramienta]), agente_module_1.AgenteModule],
        providers: [herramienta_service_1.HerramientaService],
        exports: [herramienta_service_1.HerramientaService],
