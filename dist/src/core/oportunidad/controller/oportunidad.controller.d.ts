...
import { AsignarOportunidadDto, CambiarEstadoOportunidadDto, CreateOportunidadDto, EditarHistorialDto, RegistrarSeguimientoDto, UpdateOportunidadDto } from '../dto/oportunidad.dto';
...
export declare class OportunidadController {
    ...
    editarHistorial(id: string, dto: EditarHistorialDto, req: any): Promise<SuccessResponseDto>;
